...
class ChannelDataPage extends StatefulWidget {
  final List<dynamic> data;
  final int index;
  final String serialNumber;

  const ChannelDataPage(
      {super.key,
      required this.data,
      required this.index,
  ...
  @override
  State<ChannelDataPage> createState() => _ChannelDataPageState();
}

class _ChannelDataPageState extends State<ChannelDataPage> {
  @override
